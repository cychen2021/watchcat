    ...
    def __call__(self, post: Post) -> bool:
        ...
        if self.kind == ArxivFilterKind.TITLE:
            ...
            if "term" in self.filter_args:
                ...
                return (term in post.url.lower() or
                       term in post.source.lower() or
                       term in post.abstract.lower())
            ...
            if "name" in self.filter_args:
                ...
                return (name in post.abstract.lower() or
                       name in post.source.lower())
...
class Arxiv(Source):
    ...
    def construct_query(self, filters: Collection[ArxivFilter]) -> str:
        ...
        for filter_obj in filters:
            if filter_obj.kind == ArxivFilterKind.TITLE:
                ...
                if "start" in filter_obj.filter_args and "end" in filter_obj.filter_args:
    ...
    def _fetch_papers_from_arxiv(self, query: str, max_results: int = 100) -> list[ArxivPaper]:
        ...
        try:
            ...
            for entry in entries:
                try:
                    ...
                    publish_date = datetime.fromisoformat(published_str.replace('Z', '+00:00'))
